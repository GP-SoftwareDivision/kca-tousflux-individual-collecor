...
class NIHN():
    ...
    def crawl(self):
            try:
                ...
                while(crawl_flag):
                    try:
                        if self.page_num == 0: url = 'https://hfnet.nibiohn.go.jp/whats_new/'
                        else: url = f'https://hfnet.nibiohn.go.jp/whats_new/{self.page_num}/'
                        ...
                        if res.status_code == 200:
                            ...
                            for data in datas:
                                try:
                                    wrt_dt = self.utils.parse_date_with_locale(datas[0].find('time').text.strip(), self.chnnl_nm) + ' 00:00:00'
    ...
    def crawl_detail(self, product_url):
        ...
        try:
            ...
            if self.page_num == 0: referer_url = 'https://hfnet.nibiohn.go.jp/whats_new/'
